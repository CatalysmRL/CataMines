...
public class FileManager {
    ...
    public void setupLanguageFiles() {
        ...
        if (!langFile.exists()) {
            ...
            langCfg = new ConfigFile(new File(dataFolder + "/languages", "messages_en.yml"));
            return;
        }
        langCfg = new ConfigFile(new File(dataFolder + "/languages", "messages_" + plugin.getConfig().getString("language").toLowerCase() + ".yml"));
    }
