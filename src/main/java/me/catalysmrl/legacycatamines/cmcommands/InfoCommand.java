...
public class InfoCommand implements CommandInterface {
    ...
    public boolean onCommand(CommandSender sender, Command command, String commandLabel, String[] args) {
        ...
        if (args.length == 2) {
            ...
            cuboidCataMine.getBlocks().forEach(block -> sender.sendMessage("  " + ChatColor.GOLD + block.getBlockState().getAsString(true) + ChatColor.AQUA + " , " + ChatColor.RED + block.getChance() + "%"));
